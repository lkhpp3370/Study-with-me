...
app.use(cors({
  origin: [
    ...
    'https://study-with-me-h3q7.onrender.com'
  ],
  credentials: true,
}));
...
app.get('/kakao-map.html', (req, res) => {
  try {
    ...
    const file = fs.readFileSync(path.join(__dirname, 'public', 'kakao-map.html'), 'utf8');
    const html = file.replace(/__KAKAO_JS_KEY__/g, key);
